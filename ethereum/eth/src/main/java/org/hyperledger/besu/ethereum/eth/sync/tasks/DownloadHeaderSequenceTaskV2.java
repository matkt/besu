...
import org.hyperledger.besu.ethereum.eth.manager.task.AbstractGetHeadersFromPeerTaskV2;
import org.hyperledger.besu.ethereum.eth.manager.task.AbstractPeerTask.PeerTaskResult;
import org.hyperledger.besu.ethereum.eth.manager.task.AbstractRetryingPeerTask;
import org.hyperledger.besu.ethereum.eth.manager.task.GetHeadersFromPeerByHashTaskV2;
 ...
 */
public class DownloadHeaderSequenceTaskV2 extends AbstractRetryingPeerTask<List<BlockHeader>> {
  private static final Logger LOG = LoggerFactory.getLogger(DownloadHeaderSequenceTaskV2.class);
  ...
  private DownloadHeaderSequenceTaskV2(
    ...
    headers = new LightBlockHeader[segmentLength];
    lastFilledHeaderIndex = segmentLength;
  }

  public static DownloadHeaderSequenceTaskV2 endingAtHeader(
      final ProtocolSchedule protocolSchedule,
      final ProtocolContext protocolContext,
      final EthContext ethContext,
      final BlockHeader referenceHeader,
      ...
      final ValidationPolicy validationPolicy,
      final MetricsSystem metricsSystem) {
    return new DownloadHeaderSequenceTaskV2(
        protocolSchedule,
        protocolContext,
        ethContext,
        referenceHeader,
  ...
  private CompletableFuture<PeerTaskResult<List<BlockHeader>>> downloadHeaders(
    ...
    return executeSubTask(
        () -> {
          ...
          final AbstractGetHeadersFromPeerTaskV2 headersTask =
              GetHeadersFromPeerByHashTaskV2.endingAtHash(
                  ethContext,
                  referenceHash,
