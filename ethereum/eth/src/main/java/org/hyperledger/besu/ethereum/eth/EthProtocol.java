...
public class EthProtocol implements SubProtocol {
  ...
  private List<Integer> disabledProtocolMessages;
  ...
  public static EthProtocol get(final boolean isMergeSupported) {
    if (INSTANCE == null) {
      INSTANCE =
          new EthProtocol(isMergeSupported ? mergeSupportExcludedMessages : new ArrayList<>());
    }
    return INSTANCE;
  }
