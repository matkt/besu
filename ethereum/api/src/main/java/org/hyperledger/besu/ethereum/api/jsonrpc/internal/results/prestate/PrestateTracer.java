 ...
 *
 * <p>Mirrors Geth's {@code eth/tracers/native/prestate.go}: snapshots the pre-transaction state of
 ...
 *
 * @see <a
 *     href="https://geth.ethereum.org/docs/developers/evm-tracing/built-in-tracers#prestate-tracer">
