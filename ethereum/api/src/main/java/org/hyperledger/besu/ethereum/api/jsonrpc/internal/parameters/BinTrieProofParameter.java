...
import org.hyperledger.besu.ethereum.core.witness.BinTrieProof;
...
public class BinTrieProofParameter {
  ...
  public static BinTrieProofParameter fromBinTrieProof(final BinTrieProof verkleProof) {
    return new BinTrieProofParameter(
  ...
  public static BinTrieProof toBinTrieProof(final BinTrieProofParameter verkleProofParameter) {
    return new BinTrieProof(
