...
@Disabled(
    "needs a binary protocol-schedule hook in AbstractIsolationTests; "
        + "rolling semantics covered by PbtLogRollingTests")
public class PbtSnapshotIsolationTests extends AbstractIsolationTests {
