...
class BonsaiWorldStateProviderTest {
  ...
  void testGetMutableReturnPersistedStateWhenNeeded() {
    ...
    when(trieLogLayer1.getDataStorageFormat()).thenReturn(DataStorageFormat.BONSAI);
  ...
  void testGetMutableWithStorageConsistencyToRollbackAndRollForwardTheState() {
    ...
    when(trieLogLayerA.getDataStorageFormat()).thenReturn(DataStorageFormat.BONSAI);
    ...
    when(trieLogLayerB.getDataStorageFormat()).thenReturn(DataStorageFormat.BONSAI);
