...
class AmsterdamGasCalculatorTest {
  ...
  void eip2780AuthorizationIntrinsicChargesOnlyTheStateIndependentBase() {
    // EIP-2780 (devnet-7): the intrinsic charges only REGULAR_PER_AUTH_BASE_COST (7,816) per
    // authorization; ACCOUNT_WRITE is charged at the top frame on the authority's pre-state.
