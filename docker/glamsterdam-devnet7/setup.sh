#!/usr/bin/env bash
#
# Glamsterdam devnet 7 — Besu (EL) + Prysm (CL) Docker setup
#
# Connects a local Besu execution client and Prysm beacon node to the
# ethPandaOps Glamsterdam devnet 7 testnet.
#
# Network config: https://glamsterdam-devnet-7.ethpandaops.io/
#
# Usage examples:
...
#   ./setup.sh start --prysm-image ethpandaops/prysm-beacon-chain:glamsterdam-devnet-7
#
...
# --- Glamsterdam devnet 7 network constants (ethPandaOps) ---
readonly CONFIG_BASE_URL="https://config.glamsterdam-devnet-7.ethpandaops.io"
readonly INVENTORY_URL="${CONFIG_BASE_URL}/api/v1/nodes/inventory"
readonly CHAIN_ID="7082904758"
readonly DEPOSIT_CONTRACT="0x00000000219ab540356cBB839Cbe05303d7705Fa"
readonly DEFAULT_CHECKPOINT_SYNC_URL="https://checkpoint-sync.glamsterdam-devnet-7.ethpandaops.io"
# Default EL bootnodes (Glamsterdam devnet 7); override with BESU_BOOTNODES or --bootnodes.
readonly DEFAULT_BESU_BOOTNODES="enode://2c82017536b1b74b62aa2a81769f4a1213ac9edd3a1df43af5fd008f3305e92bfd9351db9881c9c09de2afc79d3f7f6c271cf2f7231f9021926c0674dc02035c@159.223.116.60:30303?discport=30303,enode://02c8ee3b0c450163b3b3c2647eb7944a7cba75dbb8ff8787c9058d59b9d432c11b8560115883057629a7dff2d7cc03edbba929b70a8fc1c75ac259988e129484@137.184.54.22:30303?discport=30303,enode://9dfea7d6944ee43d37d6d8804b47d85a935dcf4c4621d7f6bccaeeaba814d54dd17f1df9fe6840b41c1ee94cf1a0fc934909dc99f202db8c0ba4f9a70e7d0401@142.93.250.216:30303?discport=30303,enode://bc99e19698a529be43fe9d3e730116d5c77de62764b5817afb247f18a21b7fabd8d2e2cf9b1d76874a2e8c7da656d6d51ca7d471c93e6d5845b79ef62fcf53b8@64.227.20.51:30303?discport=30303,enode://28e236f374fead5c5d3b0e77edcc10ee9ccd5274682099b0d8c50dbfe496ee568deac4d97aed28d905da9a2323a7e14d9c7268c84d681cfcb662cfb1f6bcd2a2@157.230.2.168:30303?discport=30303,enode://41bee1b24248d65a27afaa1ee8b987f1d9b345a64b225ebadafb7e11190ba7028e598f51401451147668b9a638a9d447093d3bc7444062259dcd1a36b38256d0@137.184.217.175:30303?discport=30303"

# --- Defaults (overridable via CLI) ---
REPO_ROOT="$(cd "${SCRIPT_DIR}/../.." && pwd)"
DEFAULT_DATA_DIR="${HOME}/.glamsterdam-devnet7"
# Built from current repo branch via `./setup.sh build` or auto-built on first `start`.
DEFAULT_BESU_IMAGE="besu:glamsterdam-devnet7-local"
DEFAULT_PRYSM_IMAGE="ethpandaops/prysm-beacon-chain:glamsterdam-devnet-7"
...
Options:
  -d, --data-dir PATH       Base directory for all node data (default: ~/.glamsterdam-devnet7)
      --besu-data-dir PATH  Besu data path override (default: <data-dir>/besu)
      --prysm-image IMAGE   Prysm beacon-chain Docker image (default: ethpandaops/prysm-beacon-chain:glamsterdam-devnet-7)
      --besu-image IMAGE    Besu Docker image (default: besu:glamsterdam-devnet7-local, built from repo)
      ...
      --bootnodes ENODES      Override EL bootnodes (comma-separated; default: Glamsterdam devnet 7 list)
...
besu_container_jwt_source() {
  docker inspect glamsterdam7-besu \
...
build_besu_image() {
  ...
  [[ -n "${version}" ]] || version="glamsterdam-devnet7-local"
